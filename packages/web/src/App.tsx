            ...
            <div style={{ color: '#1e293b' }}>
              ...
              <div style={{ background: '#eff6ff', border: '1px solid #bfdbfe', borderRadius: 8, padding: '12px 16px' }}>
                <span style={{ fontSize: 13, color: '#1d4ed8' }}>
                  ...
                  <code style={{ background: '#dbeafe', color: '#1e40af', padding: '2px 6px', borderRadius: 3, fontSize: 12 }}>promptfuel strategies</code>
                  {' '}in your terminal to automatically scan your Claude Code project history — no copy-pasting needed.
                </span>
              </div>
            </div>
          )}
